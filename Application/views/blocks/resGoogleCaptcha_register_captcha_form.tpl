[{if $oViewConf->resGoogleCaptcha_getSiteKey() ne "" && $oViewConf->resGoogleCaptcha_showRegisterCaptcha()}]
    <div class="form-group">
        <label class="control-label col-lg-3 req">[{oxmultilang ident="RES_GOOGLE_CAPTCHA_FORM_LABEL"}]</label>
        <div class="col-lg-9">
